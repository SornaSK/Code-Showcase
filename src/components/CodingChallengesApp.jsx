  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-800 to-gray-900 text-white py-16 px-6">
      <div className="container mx-auto">
        <h1 className="text-5xl font-bold text-center mb-12 text-cyan-400">Code Showcase</h1>
          ...
          {challenges.map(challenge => (
            <button
              ...
              className={`px-6 py-3 rounded-lg transition duration-300 
                ${activeChallenge === challenge.id ? 'bg-cyan-500 shadow-lg' : 'bg-gray-700 hover:bg-gray-600'}`}
            >
              {challenge.name}
            </button>
          ))}
        ...
        <div>
          {challenges.map(challenge => (
            activeChallenge === challenge.id && (
              <div key={challenge.id} className="p-6 bg-gray-800 rounded-lg shadow-xl">
                <challenge.component />
              </div>
            )
          ))}
      ...
      {/* Footer */}
      <footer className="mt-16 bg-gray-700 text-gray-300 py-6">
